...
class Popular extends React.Component {
	...
	render() {
		return (
			<div style={{display: 'grid', gridTemplateColumns: '1fr 1fr 1fr 1fr 1fr', maxWidth: '1200px', margin: '0 auto'}}>
				{
...
function Repo(props){
	...
	return (
		<div>
			<p>{"#" + props.rank}</p>
			<h1>{name}</h1>
			<img style={{borderRadius: "50%", width: '150px', height: '150px'}} src={owner.avatar_url} />
		</div>
